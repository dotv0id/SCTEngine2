...
SCTMouseWin32::SCTMouseWin32(IDirectInput8 *inputDevice)
...
SCTReturn SCTMouseWin32::Initialize()
{
	HRESULT hr;
	...
	hr = mpMouse->SetCooperativeLevel(Core::SCTWindows::getSingleton().GetRenderWindow(), DISCL_FOREGROUND | DISCL_NONEXCLUSIVE);
	if(hr != S_OK)
	{
		return FAIL;
	}
...
SCTReturn SCTMouseWin32::Update()
{
...
SCTReturn SCTMouseWin32::Shutdown()
{
...
SCTReturn SCTMouseWin32::UpdateMouseDevice()
{
	HRESULT hr;
